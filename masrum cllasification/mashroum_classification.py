# -*- coding: utf-8 -*-
"""mashroum classification.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/18uUSgHynT63T3LBrfo_txfmVnJ34MnrG
"""
...
master = tk.Tk() # Use tk.Tk() instead of just Tk()
master.title("Mushroom Classification Using Machine Learning")


label = tk.Label(master, text = "Mushroom Classification Using Machine Learning"
                          , bg = "black", fg = "white"). \
                               grid(row=0,columnspan=2)
